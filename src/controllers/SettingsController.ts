...
import { BlockOffDto, LeadTimeDto, SettingsDto } from '../dto/settings/SettingsDtos';
...
export class SettingsController implements IExpressController {
  ...
  private initializeRoutes() {
    this.router.post(`${this.path}/timing/blockoff`, CheckJWT, ScopeWriteOrderConfig, validationMiddleware(BlockOffDto), this.postBlockedOff);
    this.router.delete(`${this.path}/timing/blockoff`, CheckJWT, ScopeWriteOrderConfig, validationMiddleware(BlockOffDto), this.deleteBlockedOff);
    this.router.post(`${this.path}/timing/leadtime`, CheckJWT, ScopeWriteOrderConfig, validationMiddleware(LeadTimeDto), this.setLeadtime);
    this.router.post(`${this.path}/settings`, CheckJWT, ScopeWriteKVStore, validationMiddleware(SettingsDto), this.setSettings);
  };
